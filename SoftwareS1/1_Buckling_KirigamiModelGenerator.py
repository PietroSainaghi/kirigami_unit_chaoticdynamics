...
################################ buckling eigenvalue analysis
    ...
    namefile="Kirigami_Buckle_"+str(m)
    ## Some shortcuts
    executeOnCaeStartup()
    ...
    ##Create Step
    # Buckling with Subspace Iteration
    #mdb.models[namefile].BuckleStep(name='Buckle',
    #	previous='Initial',
    #	description='Linear Buckling Analysis',
    #	numEigen=5, vectors=10, maxIterations=30)
    # Buckling with Lanczos
    mdb.models[namefile].BuckleStep(name='Buckle',
        previous='Initial',
        description='Linear Buckling Analysis',
        numEigen=5, eigensolver=LANCZOS, minEigen=-10000, maxEigen=0.01)
    ...
    mdb.models[namefile].EncastreBC(name='Fixed End', createStepName='Buckle', region=region1)
    mdb.models[namefile].DisplacementBC(name='Actuation End', createStepName='Buckle', region=regionRF, u2=0.0, u3=0.0, ur1=0.0, ur2=0.0, ur3=0.0)
    region2=myAssembly.sets['ActuationEnd']
    mdb.models[namefile].ConcentratedForce(name='CF', createStepName='Buckle', region=regionRF, cf1=-1.0, cf2=0.0, cf3=0.0, distributionType=UNIFORM, field='', localCsys=None)
    ...
    ##Edit Keyword to request NodeFile
    partname = "Part-1"
    ...
    ##  Create job
    JobNameBuckle='Kirigami_Buckle_'+str(m)
